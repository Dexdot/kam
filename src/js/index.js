...
var _virtualScroll = __webpack_require__(6);

var _virtualScroll2 = _interopRequireDefault(_virtualScroll);

var _inobounce = __webpack_require__(13);

var _inobounce2 = _interopRequireDefault(_inobounce);

var _loop = __webpack_require__(14);
...
var roundDec = function roundDec(n) {
  ...
  _createClass(Scroll, [{
    ...
    value: function setup() {
      ...
      this.vs.on(function (e) {
        var scroll = _this.scrollY + -1 * e.deltaY;

        _this.scrollY = Math.min(Math.max(scroll, 0), _this.el.getBoundingClientRect().height - window.innerHeight);
      });

      _loop2.default.add(this.checkSmooth.bind(this), 'checkSmooth');

      _inobounce2.default.enable();
    }
  }, {
    key: 'checkSmooth',
    value: function checkSmooth() {
      if (Math.round(this.scrollY) !== Math.round(this.translate)) {
        this.translate = roundDec(lerp(this.translate, this.scrollY, this.mob ? 0.1 : 0.05));
...
var Lethargy = __webpack_require__(9).Lethargy;
var support = __webpack_require__(10);
var clone = __webpack_require__(11);
var bindAll = __webpack_require__(12);
...
var _rafEngine = __webpack_require__(15);

var _rafEngine2 = _interopRequireDefault(_rafEngine);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var loop = new _rafEngine2.default();
...
var _reveal = __webpack_require__(17);
...
var _animejs = __webpack_require__(18);
...
var Reveal = function () {
  function Reveal(el) {
    ...
    this.DOM.reveal.innerHTML = '<div class="reveal__inner"><div class="reveal__img u-bg" style="background-image:url(' + this.DOM.el.dataset.img + ')"></div></div>';
  ...
  _createClass(Reveal, [{
    ...
    value: function initEvents() {
      ...
      this.positionElement = function (ev) {
        var mousePos = (0, _mouse.getMousePosition)(ev);
        var docScrolls = {
          left: document.body.scrollLeft + document.documentElement.scrollLeft,
          top: document.body.scrollTop + document.documentElement.scrollTop
        };

        var bodyScrollY = window.lerpedScrollY || 0;

        _this.DOM.reveal.style.top = mousePos.y + 20 + bodyScrollY - docScrolls.top + 'px';
        _this.DOM.reveal.style.left = mousePos.x + 20 - docScrolls.left + 'px';
      };
    ...
    value: function showImage() {
      ...
      _animejs2.default.remove(this.DOM.revealInner);
      _animejs2.default.remove(this.DOM.revealImg);

      (0, _animejs2.default)(_extends({
        begin: function begin() {
          _this2.DOM.reveal.style.opacity = 1;
          _animejs2.default.set(_this2.DOM.el, { zIndex: 1000 });
        }
      }, this.options, {
      ...
      (0, _animejs2.default)(_extends({}, this.options, {
    ...
    value: function hideImage() {
      ...
      this.tl = _animejs2.default.timeline(_extends({
        begin: function begin() {
          _animejs2.default.set(_this3.DOM.el, {
            zIndex: 999
          });
        },
        complete: function complete() {
          _animejs2.default.set(_this3.DOM.el, { zIndex: '' });
          _animejs2.default.set(_this3.DOM.reveal, { opacity: 0 });
        }
      }, this.options)).add({
        targets: this.DOM.revealInner,
        duration: 400,
...
var getMousePosition = exports.getMousePosition = function getMousePosition(e) {
  var posx = 0;
  var posy = 0;
